...
{
    public class WordCounterStatic
    {
        bool flagOtherFiles, flagForPreposition;

        public WordCounterStatic(bool flagOtherFiles, bool flagForPreposition)
        {
        ...
        public void CountWords()
        {
            ...
            ConcurrentDictionary<string, string> dictionaryContent = GetContentAsync(files);

            ConcurrentDictionary<string, string[]> dictionaryWords = GetCDWithWords(dictionaryContent);

            RecordInDictionary(dictionaryWords);
        }

        private ConcurrentDictionary<string, string> GetContentAsync(FileInfo[] files)
        {
        ...
        private void RecordInDictionary(ConcurrentDictionary<string, string[]> dw)
        {
